...
- [Digital Mind Design: From tool AIs to Agents](https://www.linkedin.com/pulse/digital-mind-design-from-tool-ais-agents-agency42co-lm2wc/)
- [On Social Agents (Talk)](https://www.youtube.com/watch?v=mm3OADJWitk&list=PLIzwgd0roNpGoSE_qmoFQq3PGN261ukYO&index=3)
- [The Cybernetic Organization](https://www.agency42.co/blog/the-cybernetic-organization)
- [Digital Minds and their Use Cases (Talk)](https://gamma.app/docs/Digital-Minds-and-Their-Use-Cases-ehis01407jx0fiy)
...
I built this partially of my own interests and partially of motivations from a lead. Because AI made it so much easier to prototype, the nominal way of doing things at Agency/42, would be to just spike on it. We'd often be able to see exactly how feasible a project was within hours after a discovery call. The client didn't close, but I finished building it anyway. This taught me about building agent simualtions like [Stanford's Generative Agents](https://arxiv.org/abs/2304.03442). I was even able to produce my own micro-replication of the Valentines Day phenomenon seen in the paper, which you can read through and run yourself via this [notebook](https://github.com/miniverse-ai/miniverse/blob/main/examples/smallville/valentines_party.ipynb).
...
- [Try it on Github!](https://github.com/miniverse-ai/miniverse)